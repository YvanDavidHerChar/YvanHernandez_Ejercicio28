...
int main(int argc, char *argv[])
{
 ...
 double mypi, /* value for each process */ pi, /* value of pi calculated */ h,sum, /*sum of the area */ x;
 double start_time, /* starting time */ end_time, /* ending time */ computation_time;/* time for computing value of pi */
 
 char name[80]; /* char array for storing the name of the node where is located the process */
 /*Initialization */
 MPI_Init(&argc,&argv);
